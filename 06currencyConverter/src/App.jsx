...
function App() {
 ...
 const convert=()=>{ setConvertedAmount(amount*currencyInfo[to]);
  ...
  return (
    ...
    style={{backgroundImage: `url('https://images.pexels.com/photos/7412098/pexels-photo-7412098.jpeg')`}}>
   ...
   <div className="w-full">
    ...
    p-5 backdrop-blur-sm bg-white/30">
     ...
     <div className="w-full mb-1">
      <InputBox lable="From" amount={amount} 
     ...
     <div className="w-full mt-1 mb-4">
         <InputBox lable="To" amount={convertedAmount} 
     currencyOptions={options} onCurrencyChange={(currency)=>setTo(currency)}
     selectCurrency={to} amountDisable={true}   
     />
